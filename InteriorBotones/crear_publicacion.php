    ...
    <main class="container m-lg-auto justify-content-between">
        <form action="" method=post enctype="multipart/form-data">
            ...
            <?php
                    ...
                    include "../controlador/controlador_subirfoto_publicacion.php";
                ?>
                <div class="mb-4">
                    
                    <label class="form-label">titulo</label>
                    <input type="text" class="form-control" name="titulo" placeholder="Ejemplo: busco trabajo" id="pswrd"> 
                </div>
                <div class="mb-4">
                ...
                <input name="btncrearpubli" class="btn btn-primary" type="submit" value="crear publicacion">
